...
class TestSearchBook(unittest.TestCase):
	...
	def testSearchByIncompleteAuthorNameWith2Results(self):
		...
		result = searchByAuthor()
		expected = '[{"publisher": "MIT Press", "ISBN": "0-07-013151-9", "description": "No Available description.", "title": "Clean Code", "pic": "book.pic.82ce9fecdf325cb3.556e6b6e6f776e2d426f6f6b2e6a7067.jpg", "available_copies": 3, "lib_name": "COE-Library", "no_of_copies": 5}, {"publisher": "MIT Press", "ISBN": "0-07-013151-6", "description": "No Available description.", "title": "Computability, Complexity and Languages", "pic": "book.pic.82ce9fecdf325cb3.556e6b6e6f776e2d426f6f6b2e6a7067.jpg", "available_copies": 3, "lib_name": "COE-Library", "no_of_copies": 5}, {"publisher": "MIT Press", "ISBN": "0-07-013151-3", "description": "No Available description.", "title": "Introduction to Electricity", "pic": "book.pic.9dcd44ba64bbba08.303133353034303837362e6a7067.jpg", "available_copies": 3, "lib_name": "SET-Library", "no_of_copies": 5}, {"publisher": "MIT Press", "ISBN": "0-07-013151-12", "description": "No Available description.", "title": "Leanrning Python", "pic": "book.pic.82ce9fecdf325cb3.556e6b6e6f776e2d426f6f6b2e6a7067.jpg", "available_copies": 3, "lib_name": "COE-Library", "no_of_copies": 5}]'
		self.assertEquals(result.encode('ascii', 'ignore'), expected)
